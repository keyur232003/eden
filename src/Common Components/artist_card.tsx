                ...
                {iteam.detailes.map((res) => {
                  return (
                    ...
                    <div>
                      ...
                      <div
                        key={res.id}
                        className="relative  max-h-[494px] h-[494px] lg:max-h-[800px] lg:h-[800px]"
                      >
                        <ReactPlayer
                          url={res.video_url}
                          playing={true}
                      ...
                      <div className="absolute top-1/2 left-1/2 bg-white p-12" style={{transform:" translate(-50%, -50%)"}}>
                        <div className=" flex flex-col justify-center items-center w-full">
                            <p className="font-light text-sm w-full text-center leading-5 mb-2 italic">{res.slogen}</p>
                            <p className="text-2xl lg:text-4xl leading-8 lg:leading-[54px] tracking-[0.04em] font-light lg:font-normal w-full text-center mb-0 lg:mb-6">{res.artist_name}</p>
                            <a className=" button_border__bottom__9uMyC mt-8 lg:mt-6  border-b border-black list-none decoration-0  text-black text-sm font-normal leading-5 underline-none border-bottom-animation cursor-pointer">{res.artist_detailes_btn_txt}</a>
                        </div>
                      </div>
                      </div>
                      </div>
